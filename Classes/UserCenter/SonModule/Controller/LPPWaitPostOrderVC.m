...
@interface LPPWaitPostOrderVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LPPWaitPostOrderVC
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    [footView.goToPayBtn setTitle:@"查看物流" forState:UIControlStateNormal];
    [footView.goToPayBtn addTarget:self action:@selector(watchLogistics:) forControlEvents:UIControlEventTouchUpInside];
    return footView;
}
